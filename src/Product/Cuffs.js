                        ...
                        <Col md={7}>
                            ...
                            <Row >
                                <ButtonGroup className="mx-auto" aria-label="Basic example">
                                    <Button variant="light" className="btnAl" onClick={() => history.push('/Collar')}>Back</Button>
                                    <Button variant="light" className="btnAr" onClick={() => history.push('/Back')}>Next</Button>
                                </ButtonGroup>
                            </Row>
                            <Row >
